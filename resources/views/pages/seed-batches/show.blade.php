                ...
                <div class="detail-item">
                    ...
                    <dd>
                        @if($seedBatch->source_type === 'wild_collected')
                            <span class="badge badge-amber"><span class="badge-dot"></span>Wilding</span>
                        @else
    ...
    <div class="table-wrap">
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr class="hover:cursor-pointer" onclick="window.location='{{ route('plants.show', $plant->uuid) }}';">
                    <td style="font-family:var(--font-mono);font-size:11.5px;color:#64748b;text-decoration:none;">{{ substr($plant->uuid, 0, 8) }}…</a>
